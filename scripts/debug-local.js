...
async function main() {
  console.log('=== DEBUG MOVIL LOCAL: gegan.sanidad (npm run serve) ===\n');
  ...
  for (let i = 0; i < 10; i++) {
    ...
    await page.waitForTimeout(2000); // Más tiempo para wizard
  }

  // Espera manual para inspección visual
  console.log('\n⏳ Esperando 30s para inspección manual...');
